...
namespace SiteSpeakAndSing.Service
{
    public class AdminAreaAythorization : IControllerModelConvention
    {
        private readonly string area;
        private readonly string policy;

        public AdminAreaAythorization(string area, string policy)
        {
            this.area = area;
            this.policy = policy;
        }
